...
<head id="Head" runat="server" ViewStateMode="Disabled">
    ...
    <dnncrm:DnnResources runat="server" ID="DnnResources1" Provider="DnnPageHeaderProvider" />
...
<body id="Body" runat="server">
    ...
    <dnn:Form ID="Form" runat="server" ENCTYPE="multipart/form-data">
        <dnncrm:DnnResources runat="server" ID="DnnResources2" Provider="DnnBodyProvider" />
